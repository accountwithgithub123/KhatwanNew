...
public class GeekForGeek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_geek_for_geek);
    ...
    private class CompressVideo
        ...
        protected String doInBackground(String... strings)
        {
            ...
            try {
                ...
                Log.e(TAG, "doInBackground: URI : " + uri.toString()
                        + "\n Output Directory : " + strings[2]);

                // Compress video 
//                videoPath= SiliCompressor.with(GeekForGeek.this).compressVideo(uri, strings[2]);
            }
            catch (Exception e) {
                e.printStackTrace();
            }
